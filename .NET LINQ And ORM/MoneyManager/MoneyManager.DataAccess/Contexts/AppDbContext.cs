...
namespace MoneyManager.DataAccess.Contexts
{
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Category>().Property(c => c.Name).HasMaxLength(64).IsRequired();
            ...
            modelBuilder.Entity<Asset>().Property(a => a.Name).HasMaxLength(64).IsRequired();
            ...
            modelBuilder.Entity<Transaction>().Property(t => t.Comment).HasMaxLength(1024).IsRequired(false);

            modelBuilder.Entity<User>().ToTable("User");
            modelBuilder.Entity<User>().Property(u => u.Id).HasColumnType("uniqueidentifier").IsRequired();
            modelBuilder.Entity<User>().Property(u => u.Name).HasMaxLength(64).IsRequired();
            modelBuilder.Entity<User>().Property(u => u.Email).HasMaxLength(64).IsRequired();
            modelBuilder.Entity<User>().HasIndex(u => u.Email).IsUnique();
            modelBuilder.Entity<User>().Property(u => u.Hash).HasMaxLength(1024).IsRequired();
            modelBuilder.Entity<User>().Property(u => u.Salt).HasMaxLength(1024).IsRequired();
